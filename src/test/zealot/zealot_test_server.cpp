...
{
    DEF_ZCE_STATUS_ITEM(SVR_STATUS_2_1,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(SVR_STATUS_2_2,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(SVR_STATUS_2_3,zce::STATUS_STATICS::ABSOLUTE_VALUE),
};
