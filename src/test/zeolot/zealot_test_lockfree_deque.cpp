...
int test_dequechunk(int /*argc*/ , char * /*argv*/ [])
{
    ...
    size_t szalloc = ZCE_LIB::shm_dequechunk::getallocsize(dequesize);
    ...
    ZCE_LIB::shm_dequechunk *pmmap =  ZCE_LIB::shm_dequechunk::initialize(dequesize, 2048, tmproom, false);
