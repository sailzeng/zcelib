...
{
    DEF_ZCE_STATUS_ITEM(COMM_STAT_RECV_PKG_COUNT, zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_SEND_PKG_SUCC, zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_SEND_PKG_FAIL, zce::STATUS_STATICS::PER_FIVE_MINTUES),
    ...
    DEF_ZCE_STATUS_ITEM(COMM_STAT_BILL_COUNT, zce::STATUS_STATICS::PER_FIVE_MINTUES),
    ...
    // app收到的包字节数
    DEF_ZCE_STATUS_ITEM(COMM_STAT_RECV_PKG_BYTES, zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_SEND_PKG_BYTES, zce::STATUS_STATICS::PER_FIVE_MINTUES),
