...
//最小的QQ号码
static const unsigned int    MIN_QQ_NUMBER = 10000;
//管理帐户的QQ号码
static const unsigned int    ADMIN_QQ_NUMBER = 10000;

//等级封顶等级（不能达到该等级） 816改为20级，估计以后还要改
//愿望加权计算使用了这个宏，麻烦日更改后通知策划同事修改,
static const unsigned short PET_LIMIT_GRADE        = 60;
...
//QQ昵称的最大长度，实际长度是36字节
static const size_t   MAX_QQ_NICK_LEN          = 36 + 4;
...
{
    //从SVC配置文件读取
    FROM_SERVICES_INFO_FILE,
    //从配置中心读取
    FROM_SVC_CONFIG_CENTER,
};

// 通用服务类型定义， 通用服务类型<30 30以上的业务服务类型
enum COMM_SERVICES_TYPE
{
    //无效的服务器编号-----------------------------------------------------
