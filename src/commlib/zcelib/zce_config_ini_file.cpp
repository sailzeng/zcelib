...
//
ZCE_INI_Cfgfile::ZCE_INI_Cfgfile(const char *szfname)
{
    file_name_.assign(szfname);
}

ZCE_INI_Cfgfile::~ZCE_INI_Cfgfile()
{

}

//得到key值的String
size_t ZCE_INI_Cfgfile::get_private_str(const char *sec_name,
                                        const char *key_name,
...
size_t ZCE_INI_Cfgfile::get_private_allsection(char *return_str,
                                               const size_t size_ret_str)
{
    //调用static get_privateprofile_string函数完成,注意参数
...
size_t ZCE_INI_Cfgfile::getprivate_allkey(const char *sec_name,
...
//得到Int的 Key值
int ZCE_INI_Cfgfile::get_private_int(const char *sec_name,
                                     const char *key_name,
...
//得到bool的 Key值
bool ZCE_INI_Cfgfile::get_private_bool(const char *sec_name,
                                       const char *key_name,
                                       bool bDefault)
{
    //调用static get_privateprofile_string函数完成,注意参数
...
//写入String
bool ZCE_INI_Cfgfile::write_private_string(const char *sec_name,
                                           const char *key_name,
...
//修改Section
bool ZCE_INI_Cfgfile::write_private_section(const char *sec_name,
                                            const char *write_string)
{
...
//写入Int
bool ZCE_INI_Cfgfile::write_private_int(const char *sec_name,
                                        const char *key_name,
                                        const int nvalue)
{
...
//写入Bool变量
bool ZCE_INI_Cfgfile::write_private_bool(const char *sec_name,
                                         const char *key_name,
                                         const bool bvalue)
{
    //调用static write_privateprofile_string函数完成,注意参数
...
//删除Key
bool ZCE_INI_Cfgfile::del_private_key(const char *sec_name, const char *key_name)
{
...
//删除Section
bool ZCE_INI_Cfgfile::del_private_section(const char *sec_name)
{
...
size_t ZCE_INI_Cfgfile::get_privateprofile_string(
    const char  *sec_name,
    const char  *key_name,
    const char  *default_str,
    char  *return_str,
...
//读取INI文件的谋个字段作为整数返回
int ZCE_INI_Cfgfile::get_privateprofile_int(
    const char *sec_name,
    const char *key_name,
    int default_int,
    const char *file_name)
{
    ...
    char default_str[TMP_BUFFER_LEN + 1], return_str[TMP_BUFFER_LEN + 1];
    snprintf(default_str, TMP_BUFFER_LEN, "%d", default_int);
    ZCE_INI_Cfgfile::get_privateprofile_string(sec_name, key_name, default_str, return_str, 64, file_name);
    return atoi(return_str);
}

//写INI文件的谋个字段，
bool ZCE_INI_Cfgfile::write_privateprofile_string(
    const char *sec_name,
    const char *key_name,
    const char *write_string,
    const char *file_name)
...
bool ZCE_INI_Cfgfile::write_privateprofile_section(
    const char *sec_name,
    const char *write_string,
    const char *file_name)
{
