...
#define ZCE_BIT_IS_SET(value, bits) (((value) & (bits)) != 0)
#endif
#ifndef ZCE_BIT_ISNOT_SET
#define ZCE_BIT_ISNOT_SET(value, bits) (((value) & (bits)) == 0)
#endif

//主要用于某些enum class的处理，
#ifndef ZCE_U32_BIT_IS_SET
#define ZCE_U32_BIT_IS_SET(value, bits) ((static_cast<uint32_t>(value) & static_cast<uint32_t>(bits)) != 0)
#endif
#ifndef ZCE_U64_BIT_IS_SET
#define ZCE_U64_BIT_IS_SET(value, bits) ((static_cast<uint64_t>(value) & static_cast<uint64_t>(bits)) != 0)
#endif
#ifndef ZCE_U32_OR_2
