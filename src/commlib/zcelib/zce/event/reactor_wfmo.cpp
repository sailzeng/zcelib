                                       ...
                                       int event_mask)
{
    ...
    if ((event_mask & ZCE_Event_Handler::READ_MASK)
        ...
        || (event_mask & ZCE_Event_Handler::EXCEPT_MASK)
        || (event_mask & ZCE_Event_Handler::WRITE_MASK))
    {
...
//进行IO触发操作
int ZCE_WFMO_Reactor::handle_events(zce::Time_Value *time_out,size_t *size_event)
{
    int ret = 0;
    *size_event = 0;
