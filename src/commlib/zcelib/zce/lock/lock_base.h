...
private:
    ...
    ///绝对时间超时的的等待，超时后解锁
    virtual bool systime_wait(zce::Lock_Base* external_mutex, const zce::Time_Value& abs_time);

    ///相对时间的超时锁定等待，超时后，解锁
    virtual bool duration_wait(zce::Lock_Base* external_mutex, const zce::Time_Value& relative_time);
