...
class blob
{
    friend class zce::mysql::bind_data;
public:
    /*!
    * @brief
    ...
    */
    blob(enum_field_types data_type,
        ...
        blob_len_(blob_len)
    {
        assert(MYSQL_TYPE_BLOB == bind_type_
...
public:
    ...
    * @note
    */
    int stmt_query(std::string_view sqlcmd,
    ...
    */
    int stmt_get_result(size_t* num_affect,
                        size_t* last_id);
...
protected:
    ...
    void _bind_i(T&& bind_data, size_t param_num, std::index_sequence<Is...>)
    {
        ...
        {
            bind_result_.bind(Is, std::forward<T>(bind_data));
        }
    }
private:
    ...
    ///
    zce::mysql::bind_data bind_param_;
    ///
    zce::mysql::bind_data bind_result_;
