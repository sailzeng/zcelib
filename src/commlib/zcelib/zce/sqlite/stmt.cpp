...
stmt::stmt(sqlite_hdl* sqlite3_handler) :
...
//分析SQL语句，检查是否能够正确执行
int stmt::prepare(const char* sql_string)
{
...
//Bind 函数群
template<>
int stmt::bind(int bind_index, char val)
{
...
template<>
int stmt::bind(int bind_index, short val)
{
...
template<>
int stmt::bind(int bind_index, int val)
{
...
template<>
int stmt::bind(int bind_index, long val)
{
    int ret = ::sqlite3_bind_int(prepared_statement_, bind_index, static_cast<int>(val));
    if (SQLITE_OK != ret)
    {
...
template<>
int stmt::bind(int bind_index, long long val)
{
...
template<>
int stmt::bind(int bind_index, unsigned char val)
{
    int ret = ::sqlite3_bind_int(prepared_statement_, bind_index, static_cast<int>(val));
    if (SQLITE_OK != ret)
    {
...
template<>
int stmt::bind(int bind_index, unsigned short val)
{
    int ret = ::sqlite3_bind_int(prepared_statement_, bind_index, static_cast<int>(val));
    if (SQLITE_OK != ret)
    {
...
template<>
int stmt::bind(int bind_index, unsigned int val)
{
    int ret = sqlite3_bind_int(prepared_statement_, bind_index, val);
    if (SQLITE_OK != ret)
    {
...
//注意long这儿bind的是32位的喔
template<>
int stmt::bind(int bind_index, unsigned long val)
{
    int ret = ::sqlite3_bind_int(prepared_statement_, bind_index, static_cast<int>(val));
    if (SQLITE_OK != ret)
    {
...
template<>
int stmt::bind(int bind_index, unsigned long long val)
{
    int ret = ::sqlite3_bind_int64(prepared_statement_, bind_index, val);
    if (SQLITE_OK != ret)
    {
...
template<>
int stmt::bind(int bind_index, float val)
{
...
template<>
int stmt::bind(int bind_index, double val)
{
...
template<>
int stmt::bind(int bind_index, const char* val)
{
...
template<>
int stmt::bind(int bind_index, const  std::string& val)
{
    //
    int ret = ::sqlite3_bind_text(prepared_statement_,
                                  bind_index,
...
template<>
int stmt::bind(int bind_index, const stmt::BLOB_bind& val)
{
...
stmt& stmt::operator << (const stmt::BLOB_bind& val)
{
    bind<const stmt::BLOB_bind&>(current_bind_, val);
    ++current_bind_;
    return *this;
}
stmt& stmt::operator << (const std::string& val)
{
...
template<>
void stmt::column(int result_col, char& val)
{
...
template<>
void stmt::column(int result_col, short& val)
{
...
template<>
void stmt::column(int result_col, int& val)
{
...
template<>
void stmt::column(int result_col, long& val)
{
    val = ::sqlite3_column_int(prepared_statement_,
                               result_col);
    return;
...
template<>
void stmt::column(int result_col, long long& val)
{
...
template<>
void stmt::column(int result_col, unsigned char& val)
{
...
template<>
void stmt::column(int result_col, unsigned short& val)
{
...
template<>
void stmt::column(int result_col, unsigned int& val)
{
...
template<>
void stmt::column(int result_col, unsigned long& val)
{
...
template<>
void stmt::column(int result_col, unsigned long long& val)
{
...
template<>
void stmt::column(int result_col, float& val)
{
...
template<>
void stmt::column(int result_col, double& val)
{
...
template<>
void stmt::column(int result_col, stmt::BLOB_column& val)
{
...
template<>
void stmt::column(int result_col, std::string& val)
{
