                               ...
                               const void *want_address)
{
    ...
    {
        ZLOG_ERROR("[zcelib] System memory shmget fail ,sysv key = %d,last error =%d. ", sysv_key, ZCE_LIB::last_error());
        return -1;
    }
    ...
    {
        ZLOG_ERROR("[zcelib] System memory shmat fail ,last error =%d. ", ZCE_LIB::last_error());
        return -1;
    }
