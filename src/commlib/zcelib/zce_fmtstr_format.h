...
* @param[in]  flags     参考 @ref ZCE_LIB::FORMAT_STRING_FLAG
*/
...
void fmt_double(char *buffer,
                ...
                int flags = ZCE_LIB::FMT_EXPONENT | ZCE_LIB::FMT_UP);
