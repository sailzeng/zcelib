...
//从RECV管道读取数据
template <>
inline bool ZCE_Thread_Bus_Pipe<ZCE_Null_Mutex>::pop_front_recvpipe(zce::dequechunk_node *&node)
{
...
//向RECV管道写入数据
template <>
inline bool ZCE_Thread_Bus_Pipe<ZCE_Null_Mutex>::push_back_recvpipe(const zce::dequechunk_node *node)
{
...
//从SEND管道读取数据
template <>
inline bool ZCE_Thread_Bus_Pipe<ZCE_Null_Mutex>::pop_front_sendpipe(zce::dequechunk_node *&node)
{
...
//向SEND管道写入数据
template <>
inline bool ZCE_Thread_Bus_Pipe<ZCE_Null_Mutex>::push_back_sendpipe(const zce::dequechunk_node *node)
{
