...
class ZCELIB_EXPORT ZCE_Lock_Guard : public ZCE_NON_Copyable
{
public:
...
class ZCELIB_EXPORT ZCE_Read_Guard : public ZCE_NON_Copyable
{
public:
    ///构造，得到读写锁，进行读锁定
...
*/
template <class ZCE_LOCK>
class ZCELIB_EXPORT ZCE_Write_Guard : public ZCE_NON_Copyable
{
public:
    ///构造，得到读写锁，进行读锁定
