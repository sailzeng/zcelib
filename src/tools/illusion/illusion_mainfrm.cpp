...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWndEx)
    ...
    ON_WM_SETTINGCHANGE()
    ON_COMMAND(ID_FILE_OPENPROTOBUFFILES, &CMainFrame::OnFileOpenprotobuffiles)
    ON_COMMAND(ID_FILE_OPENEXCELFILE, &CMainFrame::OnFileOpenexcelfile)
END_MESSAGE_MAP()
...
void CMainFrame::OnFileOpenprotobuffiles()
{
