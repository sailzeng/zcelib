...
FileName            : zerg_consolehandler.cpp
Author              : Sail(ZENGXING)
Version             :
Date Of Creation    : 2006年10月17日
Description         : 控制台程序

Others              : 注意本代码是用于控制台调试,不注意效率,如果我注明是耗时间操作,不要在正常运行环境平凡使用.
Function List       :
    1.  ......
...
int Zerg_Console_Handler::cmd_get_zergstats(char *ret_string, size_t &str_len)
{
    ...
    ZCE_OS::timestamp (day_and_time, sizeof(day_and_time));
