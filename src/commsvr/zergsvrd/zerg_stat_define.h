...
{
    DEF_ZCE_STATUS_ITEM(ZERG_ACCEPT_PEER_COUNTER,      zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_ACCEPT_PEER_NUMBER,       zce::STATUS_STATICS::ABSOLUTE_VALUE),
    DEF_ZCE_STATUS_ITEM(ZERG_CONNECT_PEER_COUNTER,     zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_CONNECT_PEER_NUMBER,      zce::STATUS_STATICS::ABSOLUTE_VALUE),
    DEF_ZCE_STATUS_ITEM(ZERG_BUFFER_STORAGE_NUMBER,    zce::STATUS_STATICS::ABSOLUTE_VALUE),
    DEF_ZCE_STATUS_ITEM(ZERG_SEND_FRAME_COUNTER,       zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_FRAME_COUNTER,       zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_BYTES_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_SEND_BYTES_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_SUCC_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_SEND_SUCC_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_FAIL_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_SEND_FAIL_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_BLOCK_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_SEND_BLOCK_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_RECV_FRAME_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),

    DEF_ZCE_STATUS_ITEM(ZERG_UDP_RECV_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_UDP_SEND_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_UDP_RECV_BYTES_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_UDP_SEND_BYTES_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_UDP_RECV_FAIL_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(ZERG_UDP_SEND_FAIL_COUNTER,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_TRANS_USE_TIME,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_TRANS_USE_TIME,zce::STATUS_STATICS::PER_FIVE_MINTUES),
    DEF_ZCE_STATUS_ITEM(COMM_STAT_TRANS_USE_TIME,zce::STATUS_STATICS::PER_FIVE_MINTUES),

    DEF_ZCE_STATUS_ITEM(COMM_STAT_APP_ALIVE,           zce::STATUS_STATICS::PER_FIVE_MINTUES),
